...
cookies = { 
        "ltuid_v2": 401783610,
        "ltmid_v2": '14lekmx4cx_hy',
        "ltoken_v2": 'v2_CAISDGM5b3FhcTNzM2d1OCCe1IO8BijC8K_HAzC69sq_AUILYmJzX292ZXJzZWE.HuqAZwAAAAAB.MEUCIQCF1aDUpmaBu9VCw40FqIQ9Jr_O--YzLphHgtUTRFpWaQIgRIsEN-rIJ-1z8TXq3JKgCMEQdjR88pTsaQCiM2PZE38'
}
...
def load_character_data():
    ...
    if df['Character'].duplicated().any():
        raise ValueError("Duplicate characters found. Ensure unique character names.")
...
# generate teams 
def generate_teams_optimized(user_characters, character_data, num_teams=6, max_teams_per_dps=2):
    roles = {
        "Main DPS": {},
        "Sub-DPS": {},
        "Support": {}
...
async def main():
    ...
    # Generate teams
    recommended_teams = generate_teams_optimized(user_characters, character_data)
    teams_for_explanation = []

    # Convert teams to the format expected by the Gemini API
    ...
    explain_teams_with_gemini(teams_for_explanation)
